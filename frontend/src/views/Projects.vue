        ...
        <template v-else>
          ...
          <div class="project-list">
            <div class="project-row" v-for="(p, idx) in filteredProjects" :key="p.id" :class="{ reversed: idx % 2 === 1 }">
              <div class="project-visual" :style="p.cover ? { backgroundImage: 'url(' + p.cover + ')' } : { backgroundImage: 'url(https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80)' }">
